...
const TipTapEditor = ({
        ...
        if (wordLimit) {
          ...
          if (html || text) {
            ...
            if (currentWordCount + pastedWordCount > wordLimit) {
              ...
              console.warn(
                `Pasting this content would exceed the ${wordLimit} word limit. You have ${wordLimit - currentWordCount
                } words remaining.`
              );
              return true;
            }
  ...
  if (!mounted) {
    return (
      ...
      >
        <div className="bg-[#6C63FF] h-12 rounded-t-lg"></div>
        <div
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .tiptap-editor-wrapper > .bg-\\[\\#6C63FF\\] {
          position: relative;
          overflow-x: auto;
          overflow-y: visible;
        }
      ...
      <div className={`tiptap-editor-wrapper ${className}`}>
        {/* Toolbar */}
        <div className="bg-[#6C63FF] flex items-center gap-0.5 sm:gap-1 px-1 sm:px-2 py-2 sm:py-2 overflow-x-auto overflow-y-visible scrollbar-hide">
          {/* Font Size Dropdown */}
          ...
          <div className="relative flex-shrink-0 z-30">
            <button
              ...
              className="tiptap-toolbar-button px-2 sm:px-2 cursor-pointer py-1.5 sm:py-1.5 rounded text-white text-xs sm:text-sm font-medium flex items-center gap-1 sm:gap-1 touch-manipulation"
            >
              <div
            ...
            {showColorPicker && colorButtonRef && (
              <>
                ...
                <div
                  ...
                  style={{
                    top: `${colorButtonRef.getBoundingClientRect().bottom + 4
                      }px`,
                    left: `${Math.max(
                      4,
                      Math.min(
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      <input
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="flex-1 px-1.5 sm:px-2 py-1 cursor-pointer sm:py-1.5 text-xs sm:text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#6C63FF] focus:border-transparent"
                        placeholder="#000000"
                      />
                    </div>
                  </div>
          ...
          <button
            ...
            className={`tiptap-toolbar-button px-2 sm:px-3 py-1 sm:py-1.5 cursor-pointer rounded text-white text-xs sm:text-sm italic ${editor.isActive("italic") ? "active" : ""
              }`}
            title="Italic"
          >
            I
          ...
          <button
            ...
            className={`tiptap-toolbar-button px-2 sm:px-3 py-1 sm:py-1.5 cursor-pointer rounded text-white text-xs sm:text-sm underline ${editor.isActive("underline") ? "active" : ""
              }`}
            title="Underline"
          >
            U
          ...
          <button
            ...
            className={`tiptap-toolbar-button px-2 sm:px-3 py-1 sm:py-1.5 cursor-pointer rounded text-white text-xs sm:text-sm line-through ${editor.isActive("strike") ? "active" : ""
              }`}
            title="Strikethrough"
          >
            S
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive({ textAlign: "left" }) ? "active" : ""
              }`}
            title="Align Left"
          >
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive({ textAlign: "center" }) ? "active" : ""
              }`}
            title="Align Center"
          >
            <MdFormatAlignCenter
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive({ textAlign: "right" }) ? "active" : ""
              }`}
            title="Align Right"
          >
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive({ textAlign: "justify" }) ? "active" : ""
              }`}
            title="Justify"
          >
            <MdFormatAlignJustify
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive("bulletList") ? "active" : ""
              }`}
            title="Bullet List"
          >
            <MdFormatListBulleted
          ...
          <button
            ...
            className={`tiptap-toolbar-button p-1.5 sm:p-1.5 rounded text-white cursor-pointer touch-manipulation min-w-[36px] ${editor.isActive("orderedList") ? "active" : ""
              }`}
            title="Numbered List"
          >
            <MdFormatListNumbered
          ...
          <button
            ...
            className="tiptap-toolbar-button p-1 sm:p-1.5 cursor-pointer rounded text-white"
          ...
          {editor?.isActive("image") && (
            <>
              ...
              <button
                ...
                className={`tiptap-toolbar-button p-1 sm:p-1.5 cursor-pointer rounded text-white touch-manipulation min-w-[36px] ${editor.getAttributes("image").align === "left" ? "active" : ""
                  }`}
              ...
              <button
                ...
                className={`tiptap-toolbar-button p-1 sm:p-1.5 rounded cursor-pointer text-white touch-manipulation min-w-[36px] ${(editor.getAttributes("image").align === "center" ||
              ...
              <button
                ...
                className={`tiptap-toolbar-button p-1 sm:p-1.5 rounded cursor-pointer text-white touch-manipulation min-w-[36px] ${editor.getAttributes("image").align === "right" ? "active" : ""
                  }`}
              ...
              <div className="relative">
                <button
                  ...
                  className="tiptap-toolbar-button px-2 sm:px-3 py-1 cursor-pointer sm:py-1.5 rounded text-white text-xs sm:text-sm touch-manipulation flex items-center gap-1"
                  ...
                  >
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-base cursor-pointer font-semibold hover:bg-gray-100 transition-colors ${editor.getAttributes("image").wrapStyle === style.value ||
          ...
          <button
            ...
            className="tiptap-toolbar-button p-1 cursor-pointer sm:p-1.5 rounded text-white"
            title="Insert Image"
          >
        ...
        {showWordCount && wordLimit && (
          <div className="px-2 sm:px-4 py-1.5 sm:py-2 bg-gray-50 border-b border-gray-200 flex justify-end">
            <span
              className={`text-[10px] sm:text-xs font-medium ${wordCount > wordLimit * 0.9
                ? "text-red-600"
