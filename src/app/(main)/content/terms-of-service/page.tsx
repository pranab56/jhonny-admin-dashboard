...
export default function TermsOfServicePage() {
  const [content, setContent] = useState("<p>Welcome to our Terms of Service configuration page. You can edit your terms and conditions here using the rich text editor below.</p>");
      ...
      >
        <Card className="border-none bg-white rounded-2xl overflow-hidden shadow-none">
          <CardContent className="p-8 space-y-8">
            <h2 className="text-xl font-bold text-[#1A1D2E] border-b border-gray-50 pb-6">Terms and Service Configuration</h2>
